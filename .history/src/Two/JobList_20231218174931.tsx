  ...
  return (
    <div className="w-[40rem] rounded-md bg-white p-16">
      ...
      <div className="mt-8 grid grid-cols-4 gap-4">
        <Job title="Furniture" bgClass="bg-[#FFECEC]" icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
